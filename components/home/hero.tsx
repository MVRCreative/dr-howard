    ...
    <section className="relative overflow-hidden border-b border-hairline">
      <div className="mx-auto grid max-w-7xl gap-12 px-6 pb-20 pt-14 md:grid-cols-12 md:gap-10 md:pb-28 md:pt-20 lg:gap-16">
        <div className="md:col-span-7 lg:col-span-7">
          ...
          <h1 className="mt-8 font-display text-[2.75rem] font-medium leading-[1.02] tracking-tight text-ink text-balance sm:text-6xl lg:text-7xl">
        ...
        <div className="md:col-span-5 lg:col-span-5">
          <div className="relative">
            ...
            <div className="relative aspect-[4/5] overflow-hidden bg-bone-muted">
              <Image
                src="/professional-orthopedic-surgeon-portrait--clinical.jpg"
